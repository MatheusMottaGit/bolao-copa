...
- **Group** — `name`, `code` (auto-generated 6-char uppercase), `owner_id`, `buy_in`; auto-generates code in `booted()`. `pot()` sums all participants' bets (the winner takes the whole pot)
