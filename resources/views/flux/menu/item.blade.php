...
$trailingIconClasses = Flux::classes()
    ->add('ms-auto text-[#C9920A]/60 [[data-flux-menu-item-icon]:hover_&]:text-current')
    ->add($iconVariant === 'outline' ? 'size-5' : null)
    ;
...
$classes = Flux::classes()
    ...
    ->add(match ($variant) {
        'danger' => [
            ...
            '**:data-flux-menu-item-icon:text-[#C9920A] [&[data-active]_[data-flux-menu-item-icon]]:text-current',
        ],
        'default' => [
            'text-zinc-800 data-active:bg-zinc-50 dark:text-white dark:data-active:bg-[#C9920A]/10 dark:data-active:text-[#C9920A]',
            '**:data-flux-menu-item-icon:text-[#C9920A] [&[data-active]_[data-flux-menu-item-icon]]:text-current',
        ]
    })
    ;
